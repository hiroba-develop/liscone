...
const businessCategory = [
  { industry: "サービス業（他に分類されないもの）", sector: "SP代理店" },
  { industry: "サービス業（他に分類されないもの）", sector: "その他" },
  {
    industry: "サービス業（他に分類されないもの）",
    sector: "求人サイト・求人メディア",
  },
  { industry: "サービス業（他に分類されないもの）", sector: "広告代理店" },
  ...
  { industry: "医療、福祉", sector: "その他医療・福祉" },
  ...
  { industry: "運輸業、郵便業", sector: "自動車・輸送機器商社" },
  { industry: "運輸業、郵便業", sector: "鉄道" },
  { industry: "卸売業・小売業", sector: "アパレル・ファッション" },
  ...
  { industry: "学術研究、専門・技術サービス業", sector: "その他専門コンサル" },
  {
    industry: "学術研究、専門・技術サービス業",
  ...
  { industry: "公務（他に分類されるものを除く）", sector: "政府系金融機関" },
  {
    industry: "公務（他に分類されるものを除く）",
    sector: "団体・連合会・官公庁・独立行政法人",
  },
  {
    industry: "公務（他に分類されるものを除く）",
    sector: "社会保険労務士事務所",
  ...
  { industry: "宿泊業、飲食サービス業", sector: "ホテル・旅館・宿泊施設" },
  { industry: "宿泊業、飲食サービス業", sector: "飲食サービス" },
  { industry: "宿泊業、飲食サービス業", sector: "宿泊・飲食サービス" },
  ...
  { industry: "生活関連サービス業、娯業", sector: "その他施設・専門サービス" },
  { industry: "生活関連サービス業、娯業", sector: "環境サービス" },
  { industry: "生活関連サービス業、娯業", sector: "消費財" },
  { industry: "生活関連サービス業、娯業", sector: "消費者電子機器" },
  ...
  { industry: "電気・ガス・熱供給・水道業", sector: "電力・ガス" },
  { industry: "電気・ガス・熱供給・水道業", sector: "新エネルギー" },
  { industry: "農業、林業", sector: "農林水産・鉱業" },
  { industry: "農業、林業", sector: "飼料メーカー" },
  { industry: "農業、林業", sector: "水産・農林業" },
  { industry: "農業、林業", sector: "肥料メーカー" },
